...
def convert_detection_to_panoptic_coco_format_single_core(
    proc_id, coco_detection, img_ids, categories, segmentations_folder,ignore_overlap=True
):
    ...
    for working_idx, img_id in enumerate(img_ids):
        ...
        file_name = str('{}.png'.format(img['file_name'].rsplit('.')[0]))
...
def convert_detection_to_panoptic_coco_format(input_json_file,
    ...
    for proc_id, img_ids in enumerate(img_ids_split):
        ...
        #convert_detection_to_panoptic_coco_format_single_core(proc_id, coco_detection, img_ids, categories, segmentations_folder)
        processes.append(p)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_json_file', type=str,default="/home/asad/dev/Transformers-Tutorials/DETR/balloon_dataset/balloon/train/train_coco.json",
                        help="JSON file with detection COCO format")
    parser.add_argument('--output_json_file', type=str,default="/home/asad/dev/Transformers-Tutorials/DETR/balloon_dataset/balloon/train_panoptic_coco.json",
                        help="JSON file with panoptic COCO format")
    parser.add_argument(
        '--segmentations_folder', type=str, default="/home/asad/dev/Transformers-Tutorials/DETR/balloon_dataset/balloon/train_panoptic_annotation", help="Folder with \
    ...
    parser.add_argument('--categories_json_file', type=str,
                        ...
                        default='/home/asad/dev/Transformers-Tutorials/DETR/balloon_dataset/balloon/panoptic_categories.json')
